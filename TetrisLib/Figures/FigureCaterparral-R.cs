...
namespace TetrisLib
{
    public class FigureCaterparral_R : Figure
    {
        public static int figAmmount = 0;
        private int turnCount = 0;
        public FigureCaterparral_R() : this(0, 0) { }
        public FigureCaterparral_R(int x, int y)
            : base(x, y)
        {
            color = new RGBColor(25, 198, 99);
            figureType = "Caterparral-R";
